...
void grading()
{
		...
		for(i=1; i<=n; i++)
		{	
			printf("\n\xDB\xDB\xB2\xB2 Enter obtained marks of subject: %d   :\t",i);
			scanf("%f", &x);
...
void roll_mgmt()
{
	...
	scanf("%d",&n);
	printf("\n\n");
	printf("\xDB\xDB\xB2\xB2 Enter all the students Name&ID< >marks separated by a space or by pressing enter:\n=================== Example: Humaun1513 900 =========================================================\n\n");
